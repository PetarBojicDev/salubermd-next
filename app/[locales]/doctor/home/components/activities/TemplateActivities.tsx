            ...
            {Array.from({ length: 2 }).map((_, index) => (
              <div className="w-1/2">
                <div className="pl-3 pt-3 pb-3 inline-grid w-full">
                  <div className={`text-xs bg-gray-card-text h-4 md:w-2/3 w-1/3 rounded-md mb-1 skeleton`}></div>
                  <div className={`text-xs bg-gray-card-text h-4 md:w-4/5 w-3/5 rounded-md mb-1 skeleton`}></div>
                  <div className={`text-xs bg-gray-card-text h-4 md:w-2/3 w-1/3 rounded-md skeleton`}></div>
                </div>
              </div>    
            ))}
          </div>
