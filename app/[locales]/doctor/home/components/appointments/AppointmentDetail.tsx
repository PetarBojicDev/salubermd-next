import "server-only";
import HomepageCard from "@/app/[locales]/components/HomepageCard";
import ThreeLabels from "@/app/[locales]/components/ThreeLabels";
...
export default function AppointmentDetail({
  ...
  return (
		<div className="w-full h-1/4 mb-2 mr-5">
